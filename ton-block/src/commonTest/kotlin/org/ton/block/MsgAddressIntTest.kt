...
class MsgAddressIntTest {
    ...
    fun `parse raw addresses`() {
        val addr1 =
            MsgAddressIntStd.parseRaw("-1:3333333333333333333333333333333333333333333333333333333333333333")
        ...
        val addr2 =
            MsgAddressIntStd.parseRaw("0:83dfd552e63729b472fcbcc8c45ebcc6691702558b68ec7527e1ba403a0f31a8")
        ...
        val addr3 =
            MsgAddressIntStd.parseRaw("-1:dd24c4a1f2b88f8b7053513b5cc6c5a31bc44b2a72dcb4d8c0338af0f0d37ec5")
    ...
    fun `parse user-friendly base64(url) addresses`() {
        val bounceableAddr1 =
            MsgAddressIntStd.parseUserFriendly("Ef8zMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzM0vF")
        ...
        val nonBounceableAddr1 =
            MsgAddressIntStd.parseUserFriendly("Uf8zMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMxYA")
        ...
        val bounceableAddr2 =
            MsgAddressIntStd.parseUserFriendly("EQCD39VS5jcptHL8vMjEXrzGaRcCVYto7HUn4bpAOg8xqB2N")
        ...
        val nonBounceableAddr2 =
            MsgAddressIntStd.parseUserFriendly("UQCD39VS5jcptHL8vMjEXrzGaRcCVYto7HUn4bpAOg8xqEBI")
        ...
        val bounceableAddr3 =
            MsgAddressIntStd.parseUserFriendly("Ef_dJMSh8riPi3BTUTtcxsWjG8RLKnLctNjAM4rw8NN-xWdr")
        ...
        val nonBounceableAddr3 =
            MsgAddressIntStd.parseUserFriendly("Uf_dJMSh8riPi3BTUTtcxsWjG8RLKnLctNjAM4rw8NN-xTqu")
        ...
        val bounceableAddr4 =
            MsgAddressIntStd.parseUserFriendly("Ef/dJMSh8riPi3BTUTtcxsWjG8RLKnLctNjAM4rw8NN+xWdr")
        ...
        val nonBounceableAddr4 =
            MsgAddressIntStd.parseUserFriendly("Uf/dJMSh8riPi3BTUTtcxsWjG8RLKnLctNjAM4rw8NN+xTqu")
    ...
    fun `address to raw string`() {
        val addr1 =
            MsgAddressIntStd(null, -1, hex("3333333333333333333333333333333333333333333333333333333333333333"))
        assertEquals(
        ...
        val addr2 =
            MsgAddressIntStd(null, 0, hex("83dfd552e63729b472fcbcc8c45ebcc6691702558b68ec7527e1ba403a0f31a8"))
        assertEquals(
        ...
        val addr3 =
            MsgAddressIntStd(null, -1, hex("dd24c4a1f2b88f8b7053513b5cc6c5a31bc44b2a72dcb4d8c0338af0f0d37ec5"))
        assertEquals(
