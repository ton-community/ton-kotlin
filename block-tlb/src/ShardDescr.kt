...
private object ShardDescrOldTlbConstructor : TlbConstructor<ShardDescrOld>(
    ...
    override fun loadTlb(cellSlice: CellSlice): ShardDescrOld {
        val seqNo = cellSlice.loadUInt()
        val regMcSeqno = cellSlice.loadUInt()
        val startLt = cellSlice.loadULong()
        val endLt = cellSlice.loadULong()
        ...
        val flags = cellSlice.loadUInt(3).toInt()
        val nextCatchainSeqno = cellSlice.loadUInt()
        val nextValidatorShard = cellSlice.loadULong()
    ...
    override fun storeTlb(cellBuilder: CellBuilder, value: ShardDescrOld) {
        ...
        cellBuilder.storeBoolean(value.beforeSplit)
        cellBuilder.storeBoolean(value.beforeMerge)
        cellBuilder.storeBoolean(value.wantSplit)
        cellBuilder.storeBoolean(value.wantMerge)
        cellBuilder.storeBoolean(value.nxCcUpdated)
