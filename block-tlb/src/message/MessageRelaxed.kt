...
private class MessageRelaxedTlbConstructor<X : Any>(
    ...
    companion object {
        private val referencedStateInitCodec = Cell.tlbCodec(StateInit.Tlb)
        private val eitherStateInitCodec = Either.Companion.tlbCodec(StateInit.Tlb, CellRef(referencedStateInitCodec))
        private val maybeEitherCodec = Maybe.Companion.tlbCodec(eitherStateInitCodec)
    }

    private val eitherXCodec = Either.Companion.tlbCodec(x, CellRef(x))
