...
import org.ton.block.IhrPendingSince
import org.ton.block.ProcessedUpto
import org.ton.block.message.outmsg.EnqueuedMsg
...
private object OutMsgQueueInfoTlbConstructor : TlbConstructor<OutMsgQueueInfo>(
    ...
    val outQueue = HashmapAugE.tlbCodec(352, EnqueuedMsg.Companion, ULong.tlbConstructor())
    val procInfo = HashMapE.tlbCodec(96, ProcessedUpto.Companion)
    val ihrPending = HashMapE.tlbCodec(320, IhrPendingSince.Companion)
