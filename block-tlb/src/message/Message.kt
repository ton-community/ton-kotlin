...
private class MessageTlbConstructor<X : Any>(
    ...
    private val eitherXX = Either.Companion(x, CellRef.tlbCodec(x))
    ...
    companion object {
        private val maybeEitherStateInitStateInit =
            Maybe.Companion.tlbCodec(Either.Companion.tlbCodec(StateInit.Tlb, CellRef.tlbCodec(StateInit.Tlb)))
    }
}
