...
public fun base64(string: String): ByteArray = string.commonDecodeBase64ToArray()
    ?: throw IllegalArgumentException("Can't decode string: '${string.replace("\n", "")}'")

@Deprecated("Use kotlin stdlib instead")
public fun base64(byteArray: ByteArray): String = byteArray.commonEncodeBse64(BASE64)

@Deprecated("Use kotlin stdlib instead")
public fun base64url(string: String): ByteArray = string.commonDecodeBase64ToArray()
    ?: throw IllegalArgumentException("Can't decode string: '${string.replace("\n", "")}'")

@Deprecated("Use kotlin stdlib instead")
public fun base64url(byteArray: ByteArray): String = byteArray.commonEncodeBse64(BASE64_URL)
