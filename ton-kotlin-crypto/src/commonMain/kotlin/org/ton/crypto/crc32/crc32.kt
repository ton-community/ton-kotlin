...
expect fun crc32(bytes: ByteArray, fromIndex: Int = 0, toIndex: Int = bytes.size - fromIndex): Int
expect fun crc32c(bytes: ByteArray, fromIndex: Int = 0, toIndex: Int = bytes.size - fromIndex): Int
...
fun crc32update(crc: Int, table: IntArray, bytes: ByteArray, startIndex: Int = 0, endIndex: Int = bytes.size - startIndex): Int {
    var crc = crc.inv()
